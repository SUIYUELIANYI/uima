...
func Push(PATH, filename, content string) (string, string, string) {
	...
	url := "https://api.github.com/repos/" +
		flag_handle_fyc.OWNER + "/" +
		flag_handle_fyc.REPO +
		"/contents/" +
		PATH +
		"/" + filename
	...
	req.Header.SetBytesKV([]byte("Authorization"), []byte("token "+flag_handle_fyc.TOKEN))
	...
	args["branch"] = flag_handle_fyc.BRANCH
	...
	if ok {
		if mapResult["content"] != nil {
			...
			d = "https://cdn.jsdelivr.net/gh/" + flag_handle_fyc.OWNER + "/" + flag_handle_fyc.REPO + "@" + flag_handle_fyc.BRANCH + "/" + path
			p = path
...
func GetFiles() []map[string]interface{} {
	...
	url := "https://api.github.com/repos/" +
		...
		flag_handle_fyc.REPO +
		"/contents/" +
		flag_handle_fyc.PATH +
		"?ref=" + flag_handle_fyc.BRANCH
	...
	for _, v := range mapResult {
		v["download_url"] = "https://cdn.jsdelivr.net/gh/" + flag_handle_fyc.OWNER + "/" + flag_handle_fyc.REPO + "@" + flag_handle_fyc.BRANCH + "/" + v["path"].(string)
	}
	return mapResult
}
